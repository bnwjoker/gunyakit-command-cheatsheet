...
- This is your 3rd/4th/5th attempt? 70 points still passes
- No machine is impossible (they've all been solved before)
- Documentation > Perfect exploitation
- Good luck! 🎯
...
- **[Lab Walkthrough Examples](9.2.Lab-Walkthrough-Examples.md)** - Real attack chains: HTB Forest, AD Set

### Quick Reference for Exam

- **[AD Exploitation](../3.AD-Exploit/3.1.AD-Exploitation.md)** - AD enumeration, BloodHound, ACL abuse
- **[Kerberos Attacks](../3.AD-Exploit/3.3.Kerberos-Attacks.md)** - ASREPRoast, Kerberoasting, DCSync
- **[Windows Privilege Escalation](../4.Privilege-Escalation/4.1.Privilege-Escalation-Windows.md)** - Potato exploits, credential storage
- **[Linux Privilege Escalation](../4.Privilege-Escalation/4.2.Privilege-Escalation-Linux.md)** - SUDO, SUID, kernel exploits
- **[Ligolo-ng Guide](../5.Lateral-Movement/5.3.Ligolo-ng-Complete-Guide.md)** - Pivoting for AD Set
- **[Reverse Shell](../6.OS-Command/6.3.Reverse-Shell.md)** - Shell payloads, stabilization
