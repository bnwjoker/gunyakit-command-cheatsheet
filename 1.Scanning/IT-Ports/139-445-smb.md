...
> **📖 For complete SMB-based lateral movement, see [Lateral Movement](../../5.Lateral-Movement/5.1.Lateral-Movement.md) | [NTLM Relay](../../3.AD-Exploit/3.4.NTLM-Relay-and-Responder.md)**
