...
impacket-dcomexec $rhost -object MMC20 -silentcommand $domain/<USERNAME>:<PASSWORD> <COMMAND>
```
...
- **[AD Exploitation](../3.AD-Exploit/3.1.AD-Exploitation.md)** - Complete AD attack techniques
- **[Password Attacks](../3.AD-Exploit/3.2.Password-Attacks.md)** - Hash cracking, credential extraction, relay attacks
